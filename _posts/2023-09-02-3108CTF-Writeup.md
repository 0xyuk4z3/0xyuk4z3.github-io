...
We can use this reverse shell php file that can be downloaded from here [https://github.com/xdayeh/Php-Reverse-Shell/blob/master/PHP-Reverse-Shell.php](https://github.com/xdayeh/Php-Reverse-Shell/blob/master/PHP-Reverse-Shell.php)
